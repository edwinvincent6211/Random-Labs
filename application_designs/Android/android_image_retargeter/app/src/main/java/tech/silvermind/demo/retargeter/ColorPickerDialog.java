...
public class ColorPickerDialog extends Dialog {
    ...
    public ColorPickerDialog(Context context,
                             ...
                             int initialColor, int pickerViewRadius, int pickerCentreRadius, int yShift, @StyleRes int style) {
        //super(context, R.style.ColorPickerTheme);
        ...
        layoutParams.y = yShift;
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        if (colorPickerView == null)
            colorPickerView = new ColorPickerView(context, listener, initialColor,
                    pickerViewRadius, pickerCentreRadius);
