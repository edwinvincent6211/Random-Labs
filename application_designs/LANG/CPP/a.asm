...
0000000000001178 <_Z41__static_initialization_and_destruction_0ii>:
    ...
    118a:	83 7d fc 01          	cmpl   $0x1,-0x4(%rbp)
    118e:	75 32                	jne    11c2 <_Z41__static_initialization_and_destruction_0ii+0x4a>
    1190:	81 7d f8 ff ff 00 00 	cmpl   $0xffff,-0x8(%rbp)
    1197:	75 29                	jne    11c2 <_Z41__static_initialization_and_destruction_0ii+0x4a>
    1199:	48 8d 3d 71 2e 00 00 	lea    0x2e71(%rip),%rdi        # 4011 <_ZStL8__ioinit>
    11a0:	e8 cb fe ff ff       	callq  1070 <_ZNSt8ios_base4InitC1Ev@plt>
    11a5:	48 8d 15 5c 2e 00 00 	lea    0x2e5c(%rip),%rdx        # 4008 <__dso_handle>
    11ac:	48 8d 35 5e 2e 00 00 	lea    0x2e5e(%rip),%rsi        # 4011 <_ZStL8__ioinit>
    11b3:	48 8b 05 3e 2e 00 00 	mov    0x2e3e(%rip),%rax        # 3ff8 <_ZNSt8ios_base4InitD1Ev@GLIBCXX_3.4>
    11ba:	48 89 c7             	mov    %rax,%rdi
    11bd:	e8 9e fe ff ff       	callq  1060 <__cxa_atexit@plt>
    11c2:	90                   	nop
    11c3:	c9                   	leaveq 
    11c4:	c3                   	retq   

00000000000011c5 <_GLOBAL__sub_I_main>:
    11c5:	f3 0f 1e fa          	endbr64 
    11c9:	55                   	push   %rbp
    11ca:	48 89 e5             	mov    %rsp,%rbp
    11cd:	be ff ff 00 00       	mov    $0xffff,%esi
    11d2:	bf 01 00 00 00       	mov    $0x1,%edi
    11d7:	e8 9c ff ff ff       	callq  1178 <_Z41__static_initialization_and_destruction_0ii>
    11dc:	5d                   	pop    %rbp
    11dd:	c3                   	retq   
...
00000000000011e0 <__libc_csu_init>:
    ...
    11e4:	41 57                	push   %r15
    11e6:	4c 8d 3d a3 2b 00 00 	lea    0x2ba3(%rip),%r15        # 3d90 <__frame_dummy_init_array_entry>
    11ed:	41 56                	push   %r14
    ...
    11fc:	55                   	push   %rbp
    11fd:	48 8d 2d 9c 2b 00 00 	lea    0x2b9c(%rip),%rbp        # 3da0 <__do_global_dtors_aux_fini_array_entry>
    1204:	53                   	push   %rbx
